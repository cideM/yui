...
let s:p.visual.left = [['#3856d1', '#ccc2f2', 62, 183], ['#3D3C44', '#dcd2d2', 238, 188]]
let s:p.tabline.tabsel = [['#3D3C44', '#dcd2d2', 238, 188]]
let s:p.tabline.middle = [['#937f8d', '#dcd2d2', 245, 188]]
let s:p.tabline.left = [['#937f8d', '#dcd2d2', 245, 188]]
...
let s:p.inactive.right = [['#937f8d', '#dcd2d2', 245, 188], ['#937f8d', '#dcd2d2', 245, 188], ['#937f8d', '#dcd2d2', 245, 188]]
let s:p.inactive.middle = [['#937f8d', '#dcd2d2', 245, 188]]
let s:p.inactive.left = [['#937f8d', '#dcd2d2', 245, 188], ['#937f8d', '#dcd2d2', 245, 188], ['#937f8d', '#dcd2d2', 245, 188]]
