set fish_color_normal DCDBDB
set fish_color_command DCDBDB
set fish_color_quote DCDBDB
set fish_color_redirection DCDBDB --bold
...
set fish_color_option DCDBDB
set fish_color_keyword DCDBDB
set fish_color_host_remote DCDBDB
set fish_color_status DCDBDB
set fish_color_match DCDBDB
set fish_color_selection --background=474356
set fish_color_search_match --background=575369

set fish_pager_color_prefix DCDBDB
set fish_pager_color_selected_prefix DCDBDB
set fish_pager_color_secondary_prefix DCDBDB

set fish_pager_color_progress DCDBDB --background=23212C
set fish_pager_color_selected_background --background=575369
set fish_pager_color_background normal
set fish_pager_color_secondary_background normal

set fish_pager_color_description DCDBDB
