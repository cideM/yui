...
" Last Updated: Sun 09 Jun 2019 04:50:31 PM CEST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#72645f', '#d50711', '#336f15', '#e96c3e',
        \ '#125ea9', '#72645f', '#72645f', '#72645f', '#72645f', '#d50711',
        \ '#336f15', '#e96c3e', '#125ea9', '#72645f', '#72645f', '#72645f']
  if has('nvim')
  ...
  hi DiffAdd guifg=NONE guibg=#e8ffd1 guisp=NONE gui=NONE cterm=NONE
  hi DiffChange guifg=NONE guibg=#f9ffa3 guisp=NONE gui=NONE cterm=NONE
  hi DiffDelete guifg=NONE guibg=#ffe5db guisp=NONE gui=NONE cterm=NONE
  hi DiffText guifg=NONE guibg=#e0f3ff guisp=NONE gui=NONE cterm=NONE
  hi Directory guifg=#72645f guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi ErrorMsg guifg=NONE guibg=#ffe5db guisp=NONE gui=NONE cterm=NONE
  ...
  hi PmenuSel guifg=#72645f guibg=#ffffff guisp=NONE gui=underline cterm=underline
  hi PmenuThumb guifg=#72645f guibg=#ffffff guisp=NONE gui=NONE cterm=NONE
  ...
  hi SpellBad guifg=NONE guibg=#ffe5db guisp=NONE gui=NONE cterm=NONE
  ...
  hi StatusLine guifg=#ffffff guibg=#72645f guisp=NONE gui=NONE cterm=NONE
  hi StatusLineNC guifg=#9f918c guibg=#ffffff guisp=NONE gui=NONE cterm=NONE
  hi! link StatusLineTerm StatusLine
  hi! link StatusLineTermNC StatusLineNC
  hi TabLine guifg=#72645f guibg=#ffffff guisp=NONE gui=NONE cterm=NONE
  hi TabLineFill guifg=NONE guibg=#ffffff guisp=NONE gui=NONE cterm=NONE
  hi TabLineSel guifg=#ffffff guibg=#72645f guisp=NONE gui=NONE cterm=NONE
  ...
  hi WarningMsg guifg=#72645f guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi WildMenu guifg=NONE guibg=#ffffff guisp=NONE gui=underline cterm=underline
  ...
  hi Error guifg=NONE guibg=#ffe5db guisp=NONE gui=undercurl cterm=undercurl
...
if s:t_Co >= 256
  ...
  hi DiffChange ctermfg=NONE ctermbg=229 cterm=NONE
  ...
  hi PmenuSel ctermfg=241 ctermbg=231 cterm=underline
  hi PmenuThumb ctermfg=241 ctermbg=231 cterm=NONE
  ...
  hi StatusLineNC ctermfg=246 ctermbg=231 cterm=NONE
  hi! link StatusLineTerm StatusLine
  hi! link StatusLineTermNC StatusLineNC
  hi TabLine ctermfg=241 ctermbg=231 cterm=NONE
  hi TabLineFill ctermfg=NONE ctermbg=231 cterm=NONE
  hi TabLineSel ctermfg=231 ctermbg=241 cterm=NONE
  ...
  hi WarningMsg ctermfg=241 ctermbg=NONE cterm=NONE
  hi WildMenu ctermfg=NONE ctermbg=231 cterm=underline
  hi Comment ctermfg=241 ctermbg=NONE cterm=italic
  hi Constant ctermfg=241 ctermbg=NONE cterm=bold
  hi Error ctermfg=NONE ctermbg=224 cterm=undercurl
...
" IncSearch            brightwhite                black
" Search               black                      brightwhite
...
" PmenuSel             black                      brightwhite                    underline
...
" WildMenu             none                       brightwhite                    underline
...
" Term colors: black red green orange blue black black black
" Term colors: black red green orange blue black black black
